...
@MapperScan(basePackages = {"com.communis.www.repository"})
@ComponentScan(basePackages = {"com.communis.www.service", "com.communis.www.exception"})
...
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/communis_pharmacy");
		hikariConfig.setUsername("communis");
		hikariConfig.setPassword("pharmacy");
